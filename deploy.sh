...
git init
git add -A
git commit -m 'Publish source code to main branch'

# 如果你想要部署到 https://USERNAME.github.io
git push -f https://github.com/Sogrey/Pagic-template.git main # main分支存放源码
...
git push -f https://github.com/Sogrey/Pagic-template.git master:gh-pages
